          ...
          {AVAILABLE_CHARACTERS.map(character => (
            ...
            >
              <div className="flex flex-col items-center">
                <div className="w-24 h-24 mb-2 overflow-hidden rounded-full border-2 border-gray-200">
                  <img 
                ...
                <h3 className="font-medium text-sm text-center">{character.name}</h3>
                <span className="text-xs text-gray-500">
                  {character.gender === 'male' ? 'Laki-laki' : 'Perempuan'}
                </span>
              </div>
            </div>
          ))}
